...
import { createdDate, numberToWords } from "../helper/commonHelperFunc";
import Nav from "./Nav";
...
const InvoiceForm = () => {
  ...
  const handleInput = (e) => {
    ...
    setInvoiceData((prevState) => {
      ...
      const discountAmount = toTwoDecimal((gstAmount * discountPercent) / 100);

      const totalValue = toTwoDecimal(gstAmount - discountAmount);
...
useEffect(() => {
  if (
    location.pathname === "/admin/invoice-edit" &&
    invoiceById?.invoice
  ) {
