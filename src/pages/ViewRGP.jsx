    ...
    <div ref={pdfRef} className=" p-6 font-body m-3 text-[13px] mx-20">
      <div className="flex flex-col items-start justify-center text-[14px]">
        <div>
          ...
          >
             {
          data?.customerDetails?.rgpType === "rgp Assured" ?  "RG ASSURED rgp"  : "RG rgp AGREEMENT"}
          </h2>{
            data?.customerDetails?.rgpType !== "rgp Assured" ?
...
<>
 ...
 data?.customerDetails?.rgpType !== "rgp Assured" && 
   ...
   <p> <br />rgp Amount: INR <span style={{ textDecoration: "underline" }}>{(parseFloat(data?.vehicleDetails?.total) / 1.3).toFixed(2)}</span> (Refundable only if the vehicle is sold to Raam within the Agreement Period) <br />  <br />
   Assured rgp Premium Amount: INR <span style={{ textDecoration: "underline" }}>
  {(parseFloat(data.vehicleDetails.total) - (parseFloat(data.vehicleDetails.total) / 1.3)).toFixed(2)} </span>  (Refundable only if Raam is unable to match the price offered to you in the market before selling the vehicle, and Raam is unable or unwilling to match the offer within the Agreement Period).</p>}
       {
        ...
        <p className=" italic mt-4">
          By enrolling in the RG rgp or availing its benefits, you acknowledge
        ...
        <p className=" italic mt-4">
       By enrolling in the RG Assured rgp or availing its benefits, you acknowledge that you have read, understood, and agree to be bound by the following Terms and Conditions. If you do not agree, please revert on the email within 7 days from the date of policy generation.

        </p>}

        {!(location?.pathname === "/rgp-view" ) && (data?.customerDetails?.rgpType === "rgp" ) ?(
          <>
            ...
            <ol>
              ...
              <li>
                ...
                Contract (“RG rgp”) plan provided by the Dealer for their
                Vehicle;
              </li>
              <li>
            ...
            <p>
              2.1. The rgp shall commence on the Agreement Start Date* and
            ...
            <div>
              ...
              <h2 className="font-bold mt-4">3. Features of rgp</h2>
              ...
              >
                ...
                <li>
                  ...
                  Maintenance Services covered under the rgp package.
              ...
              <div>
                ...
                <p className="font-medium">
                  ...
                  RG rgp (rgp) DOES NOT INCLUDE the following:
                </p>
                <ol
                  type="a"
                  style={{
                ...
                <ol type="1" style={{ paddingLeft: "20px", lineHeight: "1.6" }}>
                  <li>
                    ...
                    rgp with reasonable skill, care, and diligence, in
                  ...
                  <li>
                    ...
                    <ol type="1" style={{ paddingLeft: "20px" }}>
                      ...
                      <li>
                        ...
                        any obligations of the Dealer under the rgp.
                      </li>
                    </ol>
                  </li>
                  <li>
              ...
              <li>
                ...
                <ol type="1" style={{ paddingLeft: "20px" }}>
                  <li>
                    <strong>6.1 Payment for RG rgp</strong>
                    <ol type="1" style={{ paddingLeft: "20px" }}>
                      <li>
                        6.1.1 The Customer shall pay the Dealer the full RG rgp
              ...
              <li>
                ...
                <ol type="1" style={{ paddingLeft: "20px" }}>
                  <li>
                    9.1 The benefits of the RG rgp package can be availed at any
              ...
              <li className="pt-14">
                <strong>9.2 Transfer of rgp Benefits</strong>
                <ol type="1" style={{ paddingLeft: "20px" }}>
                  <li>
                    9.2.1 The RG rgp Agreement (hereinafter referred to as the
                    "rgp") shall remain in effect and cover services as provided
                    under this Agreement for any subsequent buyer or owner
                    (hereinafter referred to as the "New Owner") of the Vehicle.
                    The benefits of the rgp, including all associated services,
                    ...
                    <ol type="1" style={{ paddingLeft: "30px" }}>
                      <li>
                        ...
                        rgp services, and failure to register within the
                  ...
                  <li>
                    9.3 Upon successful registration by the New Owner, the rgp
                    ...
                    repairs, and other services covered under the RG rgp. The
                    New Owner will be bound by all obligations, terms, and
                    conditions of the rgp from the date of registration.
                  </li>
                  <li>
                    9.4 If the New Owner owns multiple MG vehicles, the RG rgp
                    package is vehicle-specific and cannot be transferred from
                    one vehicle to another. The rgp benefits are tied to the
                  ...
                  <li>
                    ...
                    the Dealer within the specified seven (7) days, the rgp
                    ...
                    cancel any remaining benefits of the rgp for the Vehicle.
                  </li>
                  <li>
                    9.6 The Dealer reserves the right to charge a nominal fee
                    for the transfer of the rgp to a New Owner. The amount of
              ...
              <li className="pt-6">
                ...
                <ol type="1" style={{ paddingLeft: "20px" }}>
                  <li className="pt-3">
                    ...
                    is outside the scope of the RG rgp, the Dealer shall notify
                      ...
                      <li>
                        ...
                        <ul style={{ paddingLeft: "20px" }}>
                          <li>
                            ...
                            RG rgp will be made by the Dealer, in addition to
                  ...
                  <li>
                    ...
                    <ol type="a" style={{ paddingLeft: "20px" }}>
                      <li>
                        ...
                        Customer if the RG rgp is terminated due to the Vehicle
                        being declared a "Total Loss" by the Insurance Agency
                        following an accident.
                      </li>
                      <li>
                        11.2.2 In such cases, the RG rgp amount will be refunded
        ...
        <>
           ...
           <p className="mt-6">
            ...
            <p className="mt-9"><strong>a.</strong> Raam offers an Annual Maintenance Contract for Preventive Maintenance services of the vehicles for a term of certain years upon payment of a certain sum, i.e., <strong>rgp Amount</strong>.</p><br />
        
        <p><strong>b.</strong> The Customer has the option to purchase an Assured rgp Plan by paying an additional amount equivalent to <strong>30% of rgp Amount</strong>, hereinafter referred to as the <strong>“Assured rgp Premium Amount”</strong>.</p><br />
      
        <p><strong>c.</strong> Under the Assured rgp Plan, the Customer is entitled to the following benefits:</p>
        <ul className="ml-[20px]  pt-20">
          <li>A) Preventive Maintenance services as per point 4.1 mentioned below in the document.</li>
          <li>B) A guaranteed buyback offer where, if the Customer sells the vehicle back to Raam within the agreement period, Raam shall refund the rgp Amount to the Customer.</li>
          <li>C) If the Customer chooses to sell the vehicle in the market and provides documentary proof indicating a higher resale value than RG's offer (including the rgp refund amount), RG will refund only the Assured rgp Premium amount instead of the complete rgp Amount.</li>
        </ul><br />
        <p><strong>d.</strong> The Plan offers: <br /> Annual Maintenance Contract (rgp)  benefits for the designated vehicle for the agreed period; along with 
        <br/>b) an assured buyback option with a refund of the rgp amount (<em>excluding GST amount</em>).</p><br />


            <p><strong>e.</strong> The Customer is desirous of entering into a RG Assured rgp Agreement provided by Raam for their Vehicle.</p><br />
...
<br />
      ...
      SERVICES & TERMS:
        ...
        <p style={paragraphStyle}>1.1. The Plan includes rgp services for a period till valid date or valid kilometre’s (mentioned in the initial section), whichever is earlier.</p>
        <p style={paragraphStyle}>1.2. The rgp services shall be availed exclusively at authorized Raam service centres.</p>
        <p style={paragraphStyle}>1.3. The rgp covers periodic servicing, and select repairs as per rgp terms and conditions in 4.1 mentioned in the document.</p>
        <p style={paragraphStyle}>1.4. Any services availed outside Raam service centers will not be covered under this Plan and may result in forfeiture of rgp benefits.</p>
        <p style={paragraphStyle}>1.5. The Customer may avail of the rgp amount refund option before completing valid date as specified in the Plan terms.</p>
        <p style={paragraphStyle}>1.6. The rgp amount refund option can be exercised only upon the sale of MG Car to Raam or purchase of a new Car in exchange for the original MG Car from Raam</p>
        <p style={paragraphStyle}>1.7. Upon returning the vehicle to Raam under this Plan, Raam shall offer a refund of the rgp Amount along with the Buyback value of the car.</p>
        ...
        <p style={paragraphStyle}>1.9. If Raam is unable to match the higher price (including the rgp amount), it shall refund the Assured rgp Premium amount paid by the Customer only (excluding applicable taxes, if any).</p>
        <p style={paragraphStyle}>1.10. It is explicitly agreed by the Customer that if he sells vehicle to anyone other than Raam, he shall receive only the Assured rgp Premium amount and not the full rgp Amount. The rgp premium amount refund is subjective to the conditions mentioned in the 15th point.</p>
        ...
        <p style={paragraphStyle}>2.1. This RG Assured rgp Plan shall commence on the Agreement Start Date* and remain in effect for the Agreement Period*, unless terminated earlier upon the occurrence of any of the following events:</p>
        <p style={{ marginLeft: '20px' }}>
          ...
          f) The transfer / sale of vehicle to any person/ company, the RG Assured rgp shall not be transferable.
        </p>
      ...
      <div style={{  fontWeight: 'bold' }} className="pt-6">4. FEATURES OF ASSURED rgp:</div>
...
<div style={{ marginLeft: "40px" }}>
  ...
  <div>h) Pick and Drop of your MG vehicle for the Preventive Maintenance Services covered under the rgp package. Free Pick up and Drop is only applicable for Vehicles in Hyderabad Premises.</div>
...
<div style={{ marginLeft: "20px"}} className="mt-80">4.2. Limitations: RG Assured rgp (rgp) DOES NOT INCLUDE the following:</div>
...
<div style={{ marginTop: "16px" }}>5. Dealer's Obligations:</div>
  <div style={paragraphStyle}  className="ml-[20px]">5.1. The Dealer shall perform all services covered under the Assured rgp with reasonable skill, care, and diligence, in accordance with the manufacturer’s guidelines and recommended practices.</div>
  <div  style={paragraphStyle} className="ml-[20px]">5.2. The Dealer shall use only genuine MG parts, fluids, and components during the execution of any services, repairs, or replacements under the Assured rgp.</div>
  <div  style={paragraphStyle} className="ml-[20px]">5.3. The Dealer shall provide periodic maintenance and inspections of the Vehicle as per the schedule specified in the Assured rgp, ensuring the efficient, safe, and reliable operation of the Vehicle.</div>
  <div style={{ marginLeft: "20px" }}>
 
  <div style={paragraphStyle} className="ml-[20px] mt-[60px]">5.4. The Dealer shall promptly inform the Customer of any additional repairs or services needed outside the scope of the Assured rgp and shall not proceed with such work without prior approval from the Customer.</div>
...
<div style={{ marginLeft: "20px" }}>
  ...
  <div style={{ marginLeft: "20px" }}>
    ...
    <div style={paragraphStyle}>6.1.2. The Customer agrees to present the Vehicle for servicing at or within the prescribed period before the relevant service interval as per the terms of this Agreement. Failure to do so shall void the Dealer's obligations under the rgp.</div>
  ...
  <div style={{ marginLeft: "20px" }}>
    ...
    <div style={paragraphStyle} >6.4.2. The Customer shall not make any alterations or repairs to these instruments except through the Dealer or its Authorized Workshop. Non-compliance shall nullify any obligations of the Dealer under the rgp.</div>
  </div>
  ...
  <div style={{ marginLeft: "20px" }}>
    <div style={paragraphStyle} >6.8.1. The Customer agrees to cooperate with the Dealer in providing any documentation, approvals, or access to the Vehicle required to fulfill the Dealer’s obligations under the rgp.</div>
  ...
  <div style={paragraphStyle}  className="pt-6">6.9. Indemnity: The Customer shall indemnify and hold the Dealer harmless against any claims, damages, or losses arising out of the Customer’s failure to comply with their obligations under this Agreement, including but not limited to improper use, delayed servicing, or third-party actions.</div>
   ...
   <li>7.4 
             Payment for RG Assured rgp Plan
            <ol style={{  marginLeft: '20px' }}>
                <li style={paragraphStyle} >7.4.1 The Customer shall pay the Dealer the full RG Assured rgp service package amount in advance, including applicable taxes at the prevailing rates.</li>
...
<br />
    ...
    <ol style={{  marginLeft: '20px' }}>
        <li style={paragraphStyle}>10.1 The benefits of the RG Assured rgp plan package can be availed at any authorized RAAM MG workshop across India.</li>
...
<br />
    <h3 style={{ fontWeight: 'bold' }}>11. Defects and applications outside the agreement:</h3>
        <p className="pl-[20]">11.1 
            In the event that, in the Dealer’s opinion, any part or component of the Vehicle is deemed defective beyond repair and is impairing, or likely to impair, the Vehicle’s efficient, safe, and reliable operation, or could cause consequential damage, and the rectification of such defect is outside the scope of the RG Assured rgp plan, the Dealer shall notify the Customer in writing. The Dealer may recommend the replacement of the defective part or component. If the Customer refuses or fails to have such replacement carried out within fifteen (15) days of receiving the notice, or immediately if the replacement is necessary for safety, the Dealer shall be absolved from all obligations under this Agreement with respect to the Vehicle until such replacement is made.
        </p>
...
<br />
    ...
    <ol style={{ marginLeft: '20px' }} className="pt-20">
        <li>12.1
            ...
            <ol style={{ marginLeft: '20px' }}>
                <li style={paragraphStyle}>12.1.1 No foreclosure charges will be payable by the Customer if the RG Assured rgp is terminated due to the Vehicle being declared a "Total Loss" by the Insurance Agency following an accident.</li>
                <li style={paragraphStyle}>12.1.2 In such cases, the rgp amount will be refunded to the Customer on a pro-rata basis, calculated according to the period and mileage not covered by the Vehicle from the date of the Agreement. However, this is without prejudice to the Dealer's right to recover any sums due as of the effective date of the withdrawal.</li>
            </ol>
        </li>
        <li>12.2
...
<br />
    ...
    <ol style={{ marginLeft: '20px' }}>
        <li>14.1
            If the customer wants to sell the vehicle outside of Raam due to better quote i.e., higher than the sum of buyback value offered by Raam and the rgp refundable amount, then the Assured rgp Premium amount will be refunded to the customer. But the following conditions need to be fulfilled to be eligible for the rgp amount Refund-
            <ol style={{ marginLeft: '20px' }}>
        ...
        <li>14.2Once these proofs are submitted, the Assured rgp Premium amount will be refunded to Customer’s account within 30 days.</li>
    </ol>
<br />
...
<br />
    <p>By enrolling in the RG Assured rgp Plan or availing its benefits, Customer acknowledge that he/she has read, understood, and agree to be bound by the above Terms and Conditions.</p>
<br />
    <img src={stamp} alt="stamp" className="mt-9 w-[30%]" />
        </>
